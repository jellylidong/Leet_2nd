...
//where Li and Ri are the x coordinates of the left and right edge
//of the ith building, respectively, and Hi is its height.
...
//
///*my analysis, here we use a priority queue (let bigger number has higher priority)
//* more details look at the code*/
//
//    //to understand the code, just try a e.g like (2,9,10), (3,7,15)
//    //the format is (x1, x2, height)
//public class Problem218_TheSkylineProblem_PQ {
//    public List<int[]> getSkyline(int[][] b) {
//        List<int[]> res = new ArrayList<>();
//        List<int[]> height = new ArrayList<>();
//        for(int[] p: b){
//            //use - to indicate that the height is for star point
